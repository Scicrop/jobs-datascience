...
## Temos acc2 > acc.
## Isso significa que se chutarmos que nenhuma plantação foi danificada, seremos mais precisos do que o modelo. Portanto, o modelo não é muito útil por enquanto. O próximo passo seria descobrir algúm modo de aumentar a precisão do modelo. 
## Tentei aumentar a precisão de algumas formas, mas ainda não consegui, e por isso vou fazer a predição para 2020 com o modelo desse jeito mesmo
